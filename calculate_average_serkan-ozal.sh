...
VERBOSE=true CLOSE_STDOUT_ON_RESULT=false REGION_COUNT=128 java $JAVA_OPTS --class-path target/average-1.0.0-SNAPSHOT.jar dev.morling.onebrc.CalculateAverage_serkan_ozal
