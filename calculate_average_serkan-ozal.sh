...
eval "exec $fd< <({ CLOSE_STDOUT_ON_RESULT=true USE_SHARED_ARENA=true java USE_SHARED_REGION=true $JAVA_OPTS --class-path target/average-1.0.0-SNAPSHOT.jar dev.morling.onebrc.CalculateAverage_serkan_ozal; })"
read <&$fd result
echo -e "$result"
